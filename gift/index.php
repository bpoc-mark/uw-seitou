    ...
    <main>
      ...
      <section class="sect_2">
        <div class="wrapper">
          <div class="row">
            <div class="col">
              <h3 class=" c-anim-up">ギフト専門店 「ギフトピュア」<br></h3>
              <span class=" c-anim-up">GIFT PURE</span>
              <h4 class=" c-anim-up">フォーマルからカジュアルまで <br>
      ...
      <section class="sect_3">
        <div class="wrapper">
          <div class="info_cont">
            <div class="head_cont">
              <h3 class=" c-anim-up">フォーマル・カジュアル、パーソナル・法人に対応</h3>
              <p class=" c-anim-up">
