    ...
    <main>
      ...
      <section class="sect_1">
        <div class="wrapper">
          ...
          <div class="shop_cont">
            <h3 class="c-anim-up">SHOP & OFFICE</h3>
            <div class="shop_itm">
              <div class="row">
                <div class="col">
                    <h4 class="c-anim-up">株式会社セイトウ 本社</h4>
                    <p class="c-anim-up">〒438-0071 静岡県磐田市今之浦1-7-6 <br>
                    ...
                    <img src="/images/overview/shop_1.png" alt="" class="c-anim-up">
                </div>
            ...
            <div class="shop_itm">
              <div class="row">
                <div class="col">
                    <h4 class="c-anim-up">きっちんぴゅあ 笠井店</h4>
                    <p class="c-anim-up">〒431-3107 <br>
                        静岡県浜松市東区笠井町1197-22 <br class="sp">リブロス笠井内<br>
                        TEL・FAX. <a href="tel:053-435-6607">053-435-6607</a></p>
                    <img src="/images/overview/shop_2.png" alt="" class="c-anim-up">
                </div>
                <div class="col c-anim-up">
            ...
            <div class="shop_itm">
              <div class="row">
                <div class="col">
                    <h4 class="c-anim-up">きっちんぴゅあ 見付店</h4>
                    <p class="c-anim-up">〒438-0086 <br>
                      静岡県磐田市見付6038-5 <br class="sp">プラザ21 遠鉄ストア見付店内 <br>
                      TEL・FAX. <a href="tel:053-86-5340">053-86-5340</a></p>
                    <img src="/images/overview/shop_3.png" alt="" class="c-anim-up">
                </div>
                <div class="col c-anim-up">
            ...
            <div class="shop_itm">
              <div class="row">
                <div class="col">
                    <h4 class="c-anim-up">株式会社セイトウ磐田物流センター</h4>
                    <p class="c-anim-up">〒438-0013 <br class="sp">静岡県磐田市向笠竹之内字下原1239-1 <br>
                      TEL. <a href="tel:0538-38-4788">0538-38-4788</a>  ／  <br class="sp">FAX. <a href="tel:0538-38-4789">0538-38-4789</a> <br>
                      倉庫面積 ： 1386㎡</p>
                    <img src="/images/overview/shop_4.png" alt="" class="c-anim-up">
                </div>
                <div class="col c-anim-up">
